...
#     m2 = [torch.rand((x1.shape[0], 2, 80, 104), device='cuda'),
#           torch.rand((x1.shape[0], 2, 160, 208), device='cuda'),
#           torch.rand((x1.shape[0], 2, 320, 416), device='cuda')]
#     d2 = [torch.rand((x1.shape[0], 3, 80, 104), device='cuda'),
#           torch.rand((x1.shape[0], 3, 160, 208), device='cuda'),
#           torch.rand((x1.shape[0], 3, 320, 416), device='cuda')]
#
#     times = []
#     with torch.no_grad():
#         for i in range(60):
